...
echo "Replication password (set via MYSQL_REPL_PASSWORD env var or enter here):"
read -s REPLICATION_PASSWORD
REPLICATION_PASSWORD=${REPLICATION_PASSWORD:-"${MYSQL_REPL_PASSWORD:-CHANGE_ME_BEFORE_USE}"}
